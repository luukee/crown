...
<div id="site" class="why-join">
    ...
    <?php if(get_field('show_sub_yellow_bg_button_widget')) {
        $preRegisterCode = get_field('sub_yellow_form_shortcode');
        $modalId = 'pre-register-ambassador';
        ?>
        <div class="statements-yellow-box bg stands-bg container-fluid">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-xs-12 col-xs-offset-0">
                    <h5><?php the_field('sub_yellow_bg_title'); ?></h5>
                    <a href="#<?php echo $modalId; ?>" class="btn btn-styled btn-black fancybox">CONTACT US</a>
                </div>
            </div>
        </div>
